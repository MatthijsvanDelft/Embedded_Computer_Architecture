...
void loop() {
  ...
  int8_t matrixX[NR_MATRIX_ROWS][NR_MATRIX_COLS] =
  ...
  int8_t matrixY[NR_MATRIX_ROWS][NR_MATRIX_COLS] =
  ...
  int32_t matrixR[NR_MATRIX_ROWS][NR_MATRIX_COLS] = {0};

  int8_t *x = (int8_t*)matrixX;
  int8_t *y = (int8_t*)matrixY;
  int32_t *r = (int32_t*)matrixR;
